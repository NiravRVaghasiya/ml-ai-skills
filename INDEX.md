# ML / AI Skills — Master Index & Build Checklist

Legend: **[W]** = workflow skill · **[R]** = reference skill · ✅ = written · ⬜ = to do
...
- ✅ [W] `feature-engineering` — selection, extraction, leakage avoidance
- ✅ [W] `supervised-learning` — regression/classification model selection
- ✅ [W] `unsupervised-learning` — clustering, dimensionality reduction
- ✅ [W] `model-evaluation` — metrics, cross-validation, calibration
